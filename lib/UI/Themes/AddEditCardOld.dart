...
class AddEditCardOld extends StatefulWidget {
  String slug,
      fullname,
      jobTitle,
      description,
  ...
  @override
  _AddEditCardOldState createState() => _AddEditCardOldState();
}

class _AddEditCardOldState extends State<AddEditCardOld> {
  ...
  Future saveCard(String operation) {
    Provider.of<CustomViewModel>(context, listen: false)
      ...
      setState(() {
        ...
        if (widget.centralized_center_on == "1") {
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        readOnly:
                            widget.centralized_center_on == "1" ? true : false,
                        decoration: InputDecoration(
                          prefixIcon: Icon(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Bio (Optional, max 200 characters)',
                          hintStyle: TextStyle(
                              fontSize: 16, color: Color(COLOR_SUBTITLE)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(25),
