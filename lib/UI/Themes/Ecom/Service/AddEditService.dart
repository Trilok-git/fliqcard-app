...
class AddEditService extends StatefulWidget {
  String id, user_id, title, description, imagePath, videoPath;
  int index;

  AddEditService(this.id, this.index, this.title, this.description,
...
class _AddEditServiceState extends State<AddEditService> {
  ...
  Future saveCard(String operation) {
    Provider.of<CustomViewModel>(context, listen: false)
        .AddEditService(operation, widget.id, titleCotroller.text ?? "",
            descController.text ?? "", imageFile, videoFile)
        .then((value) {
      setState(() {
        Provider.of<CustomViewModel>(context, listen: false)
            .allServices()
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(COLOR_BACKGROUND),
          title: commonTitle(context, "Manage Service"),
          elevation: 0,
          leading: InkWell(
            onTap: () {
              pop(context);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      commonTitleSmall(context,
                          "Image Only, recommended 512 X 512, 1:1"),
                      SizedBox(
                        height: 10,
                      ),
                      Row(
                                ...
                                ? InkWell(
                                    onTap: () {
                                      Provider.of<CustomViewModel>(context,
                                              listen: false)
                                          .deleteServiceImage(widget.id)
                                          .then((value) {
                                        setState(() {
                                          widget.imagePath = "";
                                          imageFile = null;
                                          providerListener
                                              .servicesList[widget.index]
                                              .imagePath = "";
                                        });
                                      });
                                    },
                  ...
                  Column(
                    ...
                    children: [
                      commonTitleSmall(context,
                          "Video (mp4 Only, recommended 2:1, Horizontal)"),
                      SizedBox(
                        height: 10,
                      ),
                      Row(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            widget.id != null &&
                                    (videoFile != null || widget.videoPath != "")
                                ? InkWell(
                                    onTap: () {
                                      Provider.of<CustomViewModel>(context,
                                              listen: false)
                                          .deleteServiceVideo(widget.id)
                                          .then((value) {
                                        setState(() {
                                          widget.videoPath = "";
                                          videoFile = null;
