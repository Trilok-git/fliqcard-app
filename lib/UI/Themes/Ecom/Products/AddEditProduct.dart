...
class AddEditProduct extends StatefulWidget {
  String id, user_id, title, price, description, imagePath, videoPath;
  int index;

  AddEditProduct(this.id, this.index, this.title, this.price, this.description,
...
class _AddEditProductState extends State<AddEditProduct> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      priceCotroller.text = widget.price;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(COLOR_BACKGROUND),
          title: commonTitle(context, "Manage Product"),
          elevation: 0,
          leading: InkWell(
            onTap: () {
              pop(context);
