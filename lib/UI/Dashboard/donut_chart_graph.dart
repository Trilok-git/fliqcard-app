      ...
      child: (Row(children: [
        Expanded(
            ...
            child: (ischart > 0
                ...
                : Text(
                    "No contact in your network",
                    textAlign: TextAlign.center,
              style: GoogleFonts.montserrat(fontSize: 16.0, fontWeight: FontWeight.w300),
                  ))),
      ])),
      // ],
    );
...
List<charts.Series<LinearFliq, Object>> _createFliqData(context) {
  ...
  final Ncount = providerListener.contactsNEW_COUNT;
  ...
  final Ocount =providerListener.contactsOTHER_COUNT;
