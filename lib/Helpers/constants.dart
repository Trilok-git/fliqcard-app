...
const COLOR_PURPLE_PRIMARY = 0xFF485DCC;
const COLOR_PRIMARY = 0xFF000E57;
const COLOR_SECONDARY = 0xffEDC97A;
const COLOR_BACKGROUND = 0xffF5F6FF;
...
const registerSEPT09 = apiUrl + "/registerSEPT09.php";

const login = apiUrl + "/login.php";
const loginWithGoogle = apiUrl + "/loginWithGoogle.php";
...
const getdata = apiUrl + "/getdataAUG31.php";
//const updateContact = apiUrl + "/updateContact.php";
const updateContact = apiUrl + "/updateContact_28nov.php";
...
const centralized_toggle = apiUrl + "/centralized_toggle.php";
...
const findnearbyusers = apiUrl + "/findnearbyusers.php";
const sendonebyone = apiUrl + "/sendonebyone.php";
...
const updateBgcolor = apiUrl + "/updateBgcolor.php";
const updateCardcolor = apiUrl + "/updateCardcolor.php";
const updateFontcolor = apiUrl + "/updateFontcolor.php";

const uploadBanner = apiUrl + "/uploadBanner.php";
const uploadLogo = apiUrl + "/uploadLogo.php";
const uploadProfile = apiUrl + "/uploadProfile.php";

const allservices = apiUrl + "/allservices.php";
const allproducts = apiUrl + "/allproducts.php";
const allpaymentoptions = apiUrl + "/allpaymentoptions.php";

const deleteService = apiUrl + "/deleteService.php";
const deleteProducts = apiUrl + "/deleteProducts.php";
const deletePaymentOption = apiUrl + "/deletePaymentOption.php";

const addEditService = apiUrl + "/addEditService.php";
const addEditProduct = apiUrl + "/addEditProduct.php";
const addEditPaymentOption = apiUrl + "/addEditPaymentOption.php";

const deleteServiceImage = apiUrl + "/deleteServiceImage.php";
const deleteProductImage = apiUrl + "/deleteProductImage.php";
const deletePaymentOptionImage = apiUrl + "/deletePaymentOptionImage.php";

const deleteServiceVideo = apiUrl + "/deleteServiceVideo.php";
const deleteProductVideo = apiUrl + "/deleteProductVideo.php";

const allinterested = apiUrl + "/allinterested.php";
const allorders = apiUrl + "/allorders.php";
const completeInterest = apiUrl + "/completeInterest.php";

const updateCurrency = apiUrl + "/updateCurrency.php";
const addPaperScanToReceive = apiUrl + "/addPaperScanToReceive.php";
const addContactFromDevice = apiUrl + "/addContactFromDevice.php";

const getallappointment = apiUrl + "/getallappointment.php";
const slots_by_date = apiUrl + "/slots_by_date.php";
const toggleAppointmentDay = apiUrl + "/toggleAppointmentDay.php";
const updateDayHoursinUTC = apiUrl + "/updateDayHoursinUTC.php";
const cancelAppointment = apiUrl + "/cancelAppointment.php";
const addAppointment = apiUrl + "/addAppointment.php";
